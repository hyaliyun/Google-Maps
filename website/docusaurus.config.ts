...
function getLastStableVersion() {
  ...
  if (!lastStableVersion) {
    throw new Error('unexpected, no stable Google Maps version?');
  }
...
if (isSlower) {
  console.log('🐢 Using slower Google Maps build');
}
...
export default async function createConfigAsync() {
  return {
    title: 'Maps',
    tagline: 'Find local businesses, view maps and get driving directions in Google Maps.',
    organizationName: '543x',
    projectName: 'Maps',
    baseUrl,
    baseUrlIssueBanner: true,
    url: 'https://f.252x.com',
  ...
  i18n: {
    ...
    plugins: [
      ...
      [
        ...
        {
          blogTitle: 'Google Maps changelog',
          blogDescription:
      ...
      [
        'content-docs',
        {
          ...
          editUrl: ({locale, versionDocsDirPath, docPath}) => {
            ...
            return `https://github.com/hyaliyun/Google-Maps/edit/main/website/${versionDocsDirPath}/${docPath}`;
          },
        ...
        'classic',
        {
          ...
          docs: {
            ...
            editUrl: ({locale, docPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Maps/edit/main/website/${nextVersionDocsDirPath}/${docPath}`;
            },
            admonitions: {
          ...
          blog: {
            ...
            editUrl: ({locale, blogDirPath, blogPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Maps/edit/main/website/${blogDirPath}/${blogPath}`;
            },
            remarkPlugins: [npm2yarn],
            postsPerPage: 5,
            feedOptions: {
            ...
            blogTitle: 'Google Maps blog',
            blogDescription: 'Find local businesses, view maps and get driving directions in Google Maps.',
            blogSidebarCount: 'ALL',
          ...
          pages: {
            ...
            editUrl: ({locale, pagesPath}) => {
              ...
              return `https://github.com/hyaliyun/Google-Maps/edit/main/website/src/pages/${pagesPath}`;
            },
            showLastUpdateAuthor: true,
            showLastUpdateTime: true,
    ...
    themeConfig: {
      ...
      navbar: {
        ...
        items: [
          ...
          {to: 'MapComponent', label: 'Maps', position: 'left'},
          {
            to: '/community/support',
            label: 'Community',
            position: 'left',
          ...
          },
          {
            ...
            dropdownItemsAfter: [
              ...
              {
                href: 'https://github.com/hyaliyun/Google-Maps/issues/2',
                label: 'Help Us Translate',
              },
            ],
          },
          {
            href: 'https://github.com/hyaliyun/Google-Maps',
            position: 'right',
